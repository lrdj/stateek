(() => {
  ...
  var ConfigurableComponent = class extends GOVUKFrontendComponent {
  ...
  var Checkboxes = class _Checkboxes extends GOVUKFrontendComponent {
    /**
  ...
  var Header = class _Header extends GOVUKFrontendComponent {
    /**
  ...
  var Radios = class _Radios extends GOVUKFrontendComponent {
    /**
  ...
  var ServiceNavigation = class _ServiceNavigation extends GOVUKFrontendComponent {
    /**
     * @param {Element | null} $root - HTML element to use for header
     */
    constructor($root) {
  ...
  var SkipLink = class _SkipLink extends GOVUKFrontendComponent {
    /**
  ...
  var Tabs = class _Tabs extends GOVUKFrontendComponent {
    /**
  ...
  function initAll(config) {
    ...
    components.forEach(([Component, config2]) => {
      createAll(Component, config2, options);
    });
  }
